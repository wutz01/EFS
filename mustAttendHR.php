                    ...
                    <li class="active">
                        ...
                        $conn = mysqli_connect('localhost', 'root', '', 'efs');
                            ...
                            $college=$_SESSION['departments'];
                             ...
                             $annualyear = $_SESSION['academicyear'];
                    ...
                    <div class="col-sm-6">
                        <div class="col-sm-12">
                            ...
                            <?php
                                ...
                                }else if((strtoupper($college)=="CIHM"))
                                {
                    ...
                    <!-- <div class="col-sm-5 text-right">
                         <div class="row">
                             <div class="col-sm-6 text-right">
                                    <button class="btn btn-warning btn-lg" onClick="sendNotes()" data-toggle="modal" data-target="#mustReturn">
                                        Return to Dean <i class="fa fa-arrow-circle-o-left"></i>
                                    </button>
                            </div>
                            <div class="col-sm-6 text-right">
                                    <button class="btn btn-success btn-lg" data-toggle="modal" data-target="#mustConfirm">
                                        Submit to VPAR <i class="fa fa-arrow-circle-o-right"></i>
                                    </button>
                            </div>
                         </div>
                    </div> -->
    ...
    <div class="modal" id="mustConfirm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                <div class="row">
                     <form action="db/db_submitToDean.php" method="post" class="form" role="form" enctype="multipart/form-data">
                    <div class="col-sm-12 text-center">
                    <div class="col-sm-12 text-center">
                        <h4>Are you sure?</h4>
                        <h5 class="text-muted">Once <strong class="text-success">approved</strong>, this request will automatically forward to <strong class="text-primary">Dean</strong>.</h5>
                    </div>
                </div>
