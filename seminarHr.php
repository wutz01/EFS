        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="panel-heading">Seminar/Training Applications</div>
                        <div class="panel-body">
                            <ul class="nav nav-pills">
                                <li class="active"><a href="#offCamp" data-toggle="tab">Off-Campus</a></li>
                                <li><a href="#inHouse" data-toggle="tab">In House <span class="label label-danger">2</span></a></li>
                            </ul>
                            <br>
                            <div class="tab-content">
                                <div class="tab-pane fade in active" id="offCamp">
                                    <div class="row">
                                        <div class="col-sm-12">
                                        <p>
                                            <!-- <a data-toggle="modal" data-target="#applySem" class="btn btn-success"><i class="fa fa-plus"></i> Apply off-campus seminar</a> -->
                                            <a class="btn btn-success" href="seminarCreateOff.php"><i class="fa fa-plus"></i> Apply off-campus seminar</a>
                                        </p>
                                            <div class="table-responsive">
                                                <table class="table table-bordered">
                                                    ...
                                                    <tbody class="hoverRow">
                                                        <tr class="viewRow" data-toggle="modal">
                                                            ...
                                                            <?php
                                                                $q = mysql_query("
                                                                    ...
                                                                    AND mustattend.academicyear='2016-2017' 
                                                                    ");
                                                ...
                                                <table class="table table-bordered">
                                                    ...
                                                    <tbody class="hoverRow">
                                                        <tr>
                                                            ...
                                                            <td>Feb. 9 / <strong>5 mins</strong> left</td>
