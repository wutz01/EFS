                            ...
                            <tr class="active">
                                ...
                                <?php
                                   if((($dean=="New")&&($vp=="New"))||(($dean=="Resend")&&($vp=="New"))||(($dean=="Approved")&&($vp=="Revision"))||(($dean=="Resend")&&($vp=="Revision"))){
                                       echo '<th style="width:5%"> <input type="checkbox"></th>';
                                    }
                                ?>
                        ...
                        <tbody>
                         <?php
                             $conn = mysqli_connect("localhost","root","","efs");
                                // $departments = $college;
                            // $annualyear = $acad;
                             $result2 = mysqli_query($conn,"SELECT * FROM mustattend where department='$college' AND academicyear = '$annualyear'");
    ...
    <div class="modal" id="mustConfirm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                <div class="row">
                     <form action="db/db_submitToVpar.php" method="post" class="form" role="form" enctype="multipart/form-data">
                    <div class="col-sm-12 text-center">
                    <div class="col-sm-12 text-center">
                        <h4>Are you sure?</h4>
                        <h5 class="text-muted">Once <strong class="text-success">approved</strong>, this request will automatically forward to <strong class="text-primary">VPAR</strong>.</h5>
                    </div>
                </div>
